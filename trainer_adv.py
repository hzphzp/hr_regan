...
class Trainer(object):
    ...
    def load_model(self):
        ...
        self.start_step = max(idxes)#9999
    ...
    def train(self):
        ...
        for step in trange(self.start_step, self.max_step):
            ...
            f_AB_s0_data = Variable(f_AB_s0.data, requires_grad=False)
            l_feat_g = d(f_x_AB_g, f_AB_g_data)
            l_feat_s = d(f_x_AB_s, f_AB_s0_data)
            ...
            if step % self.log_step == 0:
                ...
                '''      
                print("[{}/{}] l_const_A: {:.4f} l_const_max: {:.4f}". \
                      format(step, self.max_step, l_const_A.data[0], l_const_max.data[0]))
