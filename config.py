...
data_arg.add_argument('--dataset', type=str, default='img_align_celeba')
...
misc_arg.add_argument('--log_step', type=int, default=2)
misc_arg.add_argument('--save_step', type=int, default=2)
misc_arg.add_argument('--num_log_samples', type=int, default=3)
misc_arg.add_argument('--log_level', type=str, default='INFO', choices=['INFO', 'DEBUG', 'WARN'])
misc_arg.add_argument('--result_dir', type=str, default='result')
misc_arg.add_argument('--experiment_name', type=str, default='test')
