...
misc_arg.add_argument('--log_step', type=int, default=2000)
...
misc_arg.add_argument('--log_dir', type=str, default='/gdata/huangzp/dsl_sgen/logs')
misc_arg.add_argument('--data_dir', type=str, default='/gdata/huangzp/dsl_sgen/data')
